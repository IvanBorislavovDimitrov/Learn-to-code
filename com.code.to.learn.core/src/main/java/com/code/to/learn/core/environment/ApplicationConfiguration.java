...
public class ApplicationConfiguration {
    ...
    private static final String HIBERNATE_CONNECTION_POOL_SIZE_VALUE = "100";
    ...
    private static final String HIBERNATE_DBCP_INITIAL_SIZE_VALUE = "20";
    private static final String HIBERNATE_DBCP_MAX_TOTAL_VALUE = "30";
    private static final String HIBERNATE_DBCP_MAX_IDLE_VALUE = "20";
    private static final String HIBERNATE_DBCP_MIN_IDLE_VALUE = "10";
    ...
    private static final int THREAD_POOL_SIZE_VALUE = 50;
